              ...
              {prefixMode && !activeSubmenu && (
                <motion.div
                  ...
                  style={{
                    ...
                    background: 'linear-gradient(90deg, var(--color-accent-primary-glow, rgba(30, 82, 241, 0.1)) 0%, transparent 100%)',
                    borderBottom: '1px solid var(--color-border-subtle, rgba(23, 20, 18, 0.06))',
                    display: 'flex',
                    alignItems: 'center',
                    gap: 8,
              ...
              {results.length > 0 && !prefersReducedMotion && (
                <motion.div
                  ...
                  style={{
                    ...
                    width: '100%',
                    height: 48,
                    background: 'linear-gradient(90deg, var(--color-accent-primary-glow, rgba(30, 82, 241, 0.08)) 0%, rgba(30, 82, 241, 0.02) 100%)',
