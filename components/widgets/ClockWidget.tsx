...
const THEME = {
  light: {
    ...
    bezelShadow: `
      0 6px 24px rgba(120, 100, 80, 0.10),
      0 3px 8px rgba(120, 100, 80, 0.06),
      inset 0 2px 3px rgba(255, 255, 255, 0.95),
      inset 0 -2px 4px rgba(180, 160, 140, 0.06)
    `,
    // Inner face - clean cream white
    faceGradient: 'linear-gradient(180deg, #faf9f7 0%, #f3f1ed 100%)',
    faceShadow: `
      inset 0 2px 8px rgba(100, 80, 60, 0.04),
      inset 0 1px 3px rgba(100, 80, 60, 0.03)
    `,
    // Tick marks
    tickMain: '#6b5c4d',
    tickMinor: '#c4b8a8',
    ...
    centerPinShadow: '0 1px 3px rgba(60, 50, 40, 0.3)',
    // Text
    timeColor: '#2a241c',
