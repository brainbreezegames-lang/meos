...
export type WindowType = 'default' | 'browser' | 'mail' | 'gallery' | 'document' | 'pages' | 'notes' | 'photos' | 'finder' | 'preview' | 'workbench' | 'board' | 'sheet' | 'slides';

// === goOS Primitive Types ===
export type GoOSFileType = 'note' | 'case-study' | 'folder' | 'image' | 'link' | 'embed' | 'download' | 'cv' | 'game' | 'board' | 'sheet' | 'invoice' | 'slides';
