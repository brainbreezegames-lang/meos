...
import { getDefaultCVContent, getDefaultBoardContent, getDefaultSheetContent, getDefaultInvoiceContent, getDefaultSlidesContent } from '@/lib/validations/goos';
...
export function GoOSProvider({
  ...
  const createFile = useCallback(async (
    ...
    const title = type === 'folder' ? 'New Folder' : type === 'cv' ? 'My CV' : type === 'board' ? 'Untitled Board' : type === 'sheet' ? 'Untitled Sheet' : type === 'invoice' ? 'New Invoice' : type === 'slides' ? 'Untitled Slides' : `Untitled ${type}`;
    ...
    const content = type === 'cv' ? JSON.stringify(getDefaultCVContent())
      ...
      : type === 'slides' ? JSON.stringify(getDefaultSlidesContent())
      : '';
